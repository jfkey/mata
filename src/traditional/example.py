...
from src.traditional.trad_ged import  graph_edit_distance
import dgl
import numpy as np
import torch
...
edge_index = torch.tensor([[0, 1, 3, 4, 5],
                           [1, 2, 4, 5, 6]], dtype=torch.long)
...
print(
    distance)  # 9.0, can be different as multiple solutions possible for the intermediate LAP used in this approximation
